...
public class VocabularyAdapter extends RecyclerView.Adapter<VocabularyAdapter.VocabularyViewHolderNew> {

    private final List<WordObj> wordList;
    private final LayoutInflater inflater;
    private final ItemClickListenerNew mListener;

    public VocabularyAdapter(Context context, ItemClickListenerNew listener) {
